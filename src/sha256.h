...
#ifndef ampheck_sha256_h
#define ampheck_sha256_h

#include <stddef.h>
#include <stdint.h>

struct ampheck_sha256
{
	uint32_t h[8];
	uint8_t buffer[64];
...
void ampheck_sha256_update(struct ampheck_sha256 *ctx, const uint8_t *data, size_t length);

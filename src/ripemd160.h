...
#ifndef ampheck_ripemd160_h
#define ampheck_ripemd160_h

#include <stddef.h>
#include <stdint.h>

struct ampheck_ripemd160
{
	uint32_t h[5];
	uint8_t buffer[64];
...
void ampheck_ripemd160_update(struct ampheck_ripemd160 *ctx, const uint8_t *data, size_t length);

...
#ifndef ampheck_sha384_h
#define ampheck_sha384_h

#include <stddef.h>
#include <stdint.h>

struct ampheck_sha384
{
	uint64_t h[8];
	uint8_t buffer[128];
...
void ampheck_sha384_update(struct ampheck_sha384 *ctx, const uint8_t *data, size_t length);
